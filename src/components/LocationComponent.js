  ...
  return(
    <div className="container-fluid" style={{height: "82.5vh"}}>
      <div className="row align-items-lg-center h-100">
        <div className="col-lg offset-xl-2 offset-lg-1 my-2">
        ...
        <div className="col-lg">
          <div className="row">
            <div className="col col-xl-4 text-center text-lg-left">
              <p>
                Smoke
                <br />
                4115 Butler Street
              ...
              <p><strong><a className="misc-links" href="https://www.google.com/maps/dir/?api=1&destination=4115+Butler+St+PITTSBURGH+Pennsylvania+15201+US" target="blank">Get Directions</a></strong></p>
            </div>
            <div className="col">
              <p>
                Monday: Closed
